...
public class Burrito {
 ...
 protected static int NoOfCustomers=0;
   ...
   {      
       ...
       System.out.println("1: Automatic Mode *automatically processes orders");
       System.out.println("2: Manual Entry Mode (Advanced) ");
       String    adv="";      
       ...
       switch (input())
       {
            ...
            case 2: // Test Mode
               ...
               System.out.println("How many CUSTOMERS to simulate?" + " MAX:30 ");
               NoOfCustomers=input();
              
               System.out.println("How many SERVERS to simulate?" + " MAX:3 ");
               NoOfServers=input();
              
               System.out.println("Setup store capacity *store capacity must be greater than 1" + " MAX:15 ");              
               while (StorCapacity<2)
               {
                   StorCapacity=input();
                   if (StorCapacity<2) System.out.println("Please Choose higher, store capacity must be greater than 1 ");  
               }
